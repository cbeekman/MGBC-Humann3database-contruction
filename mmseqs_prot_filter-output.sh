...
#mmseqs filterdb /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90 \
#                /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90_eval1e-5 \
#                --filter-column 4 --comparison-operator le --comparison-value 1e-5


#Create alignment result file in Blast tab format
#mmseqs convertalis /users/cbeekman/scratch/GImapping/databases/humann3/custom/mmseqs_repseqs/MGBC_Prot_clusters_rep.db \
...
#                   /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90.m8 \
...
#                /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90 \
#                /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90_TopHit
...
mmseqs convertalis --format-output "query,target" \
	           /users/cbeekman/scratch/GImapping/databases/humann3/custom/mmseqs_prot_repseq/MGBC_Prot_clusters_rep.db \
                   ...
                   /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90_TopHit \
                   /users/cbeekman/scratch/GImapping/databases/humann3/custom/annotated_prot_uniref90/MGBC_Prot_clusters_rep_uniref90_TopHit.tsv \
